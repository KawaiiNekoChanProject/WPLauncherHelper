...
suspend fun WPLauncherAccountAPI.sendItemComment(itemId: ULong, content: String, replyId: ULong = 0UL) = postWithAuth(
    ...
    body = """{"entity_id":"0","user_id":"${entity.entityId}","item_id":"$itemId","content":${content.toJsonString()},"master_id":"$replyId","reply_id":"$replyId","total_like":0,"create_time":${Clock.System.now().toEpochMilliseconds()},"comment_type":0}"""
)
    .body<ResponseX19Base>()
    .throwOnNotOk()
